...
export default function AppShell({ children }) {
  ...
  const isActive = (path) => {
    if (path === "/truquote") {
      return (
        location.pathname === "/truquote" ||
        location.pathname.startsWith("/truquote/edit")
      );
    }

    if (path === "/truquote/saved") {
      return (
        location.pathname === "/truquote/saved" ||
        /^\/truquote\/saved\/[^/]+$/.test(location.pathname) ||
        location.pathname.startsWith("/truquote/convert-won")
      );
    }
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "28px" }}>
          ...
          <div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
              ...
              <Link to="/truquote/saved" style={getDesktopLinkStyle("/truquote/saved")}>
                Saved Quotes
              </Link>
            </div>
          </div>
