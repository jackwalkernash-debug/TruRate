  ...
  return (
    <AppShell>
      <div className="min-h-screen bg-slate-50">
        <div className="mx-auto max-w-lg px-5 py-6 space-y-8">
          <div>
            ...
            {results && (
              ...
              >
                ...
                <div className="flex gap-3">
                  <Button
                    onClick={handleSave}
                    className="w-full h-14 rounded-2xl !bg-amber-500 !text-slate-900 hover:!bg-amber-400 border-0 shadow-sm text-base font-bold"
                  >
                    Save Job
                  </Button>
